...
export class I2CSlaveDevice {
   ...
   * ポート情報マッピング
   */
  constructor(portNumber: number, slaveAddress: number, bone: Route) {
   ...
   */
  init(portNumber: number, slaveAddress: number, bone: Route): Promise<any> {
    this.bone = bone;
   ...
   * TODO: master-slave => main-sub になっているので、いずれ変えるべき？
   */
  read8(registerNumber): Promise<void> {
    return new Promise((resolve, reject) => {
      var data = new Uint8Array([this.slaveAddress, registerNumber, 1]);
      this.bone.send(0x23, data).then(
        (result) => {
  ...
  * TODO: master-slave => main-sub になっているので、いずれ変えるべき？
  */
  read16(registerNumber): Promise<void> {
    return new Promise((resolve, reject) => {
  ...
  * TODO: master-slave => main-sub になっているので、いずれ変えるべき？
  */
  write8(registerNumber, value): Promise<void> {
    return new Promise((resolve, reject) => {
      infoLog(
  ...
  * TODO: master-slave => main-sub になっているので、いずれ変えるべき？
  */
  write16(registerNumber, value): Promise<void> {
    return new Promise((resolve, reject) => {
      infoLog(
